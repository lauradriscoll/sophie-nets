...
for i in [3,]:
    lesion_units=cluster_var['lesion_units_list'][i]
    for rule in ['delaygo',]:#
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(n_epochs):
                ...
                for t in [0,]:#range(0,n_trials,int(n_trials/2)):#[int(n_trials/2),]:#:
                    ...
                    if unique_input:
                        ...
                        if unique_fps.xstar.shape[0]>0:
                            ...
                            save_dir = os.path.join(m,lesion_folder,'lesion_fps','tf_fixed_pts_lesion'+str(i),rule)
