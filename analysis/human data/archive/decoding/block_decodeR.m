function block_decodeR(data_dir,blocks,use_trial_rule,trial_label_rule,figName,epochs)
...
for epoch = epochs
    ...
    save_path_file = fullfile(data_dir,'analysis','block_decode','zscore',[fullFigName '_blocks']);
    save_path_fig = fullfile(data_dir,'analysis','block_decode','zscore');
    ...
    for block = blocks%use_blocks
        ...
        load(fullfile(data_dir,'process','zscore',['R_process_block' num2str(block)]),...
