...
savefig(fullfile('figures','yangnet', datestr(now,'yyyymmdd'),'svm_pro_v_anti_context'))
...
savefig(fullfile('figures','yangnet', datestr(now,'yyyymmdd'),'svm_memory_v_other_context'))
