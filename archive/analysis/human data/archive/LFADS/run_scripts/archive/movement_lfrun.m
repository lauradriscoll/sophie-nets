...
date = '20180730';
blocks = [4:8 13:18]; %10:1110:12%

[ out ] = getLNDPaths( );
LFADS_data_dir = fullfile(out.dataPath,'human','yangnet',date,'process/LFADS','alignStart');
...
rc = YangExperiment.RunCollection(runRoot, 'movement', dc);
...
par.name = 'inputs3_m'; % completely optional
par.spikeBinMs = 2; % rebin the data at 2 ms
par.c_co_dim = 3; % no controller outputs --> no inputs to generator
