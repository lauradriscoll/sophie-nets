...
date = '20180815';
blocks = [2:19]; %10:1110:12%
epoch = 1;

[ out ] = getLNDPaths( );
LFADS_data_dir = fullfile(out.dataPath,'human','yangnet',date,'process/zscore','alignStim');
...
rc = YangExperiment.RunCollection(runRoot, 'alignStim_20bins_0in_e1_180815', dc);
...
par.name = 'inputs0'; % completely optional
