...
for n_number in range(1):
    for rule in task_list:
        m = os.path.join(p,all_dir,fldr,str(n_number))
        for rule in task_list:
            ...
            with tf.Session() as sess:
                ...
                hparams = model.hp
                # create a trial
                trial = generate_trials(rule, hparams, mode='test', noise_on=False, batch_size=40,
                ...
                for epoch in range(n_epochs):
                    ...
                    for t in range(0,80,10):#[int(n_trials/2),]:#:2,n_trials,int(n_trials/4)
                        ...
                        if unique_input:
                            ...
                            if unique_fps.xstar.shape[0]>0:
                                ...
                                save_dir = os.path.join(m,'tf_fixed_pts_mixed_context',rule)
