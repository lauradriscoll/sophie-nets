...
model_n = 1
dir_specific_all = 'lowD/armnet_noreg' #'varGo/lowD/'#lowD/combos' ##grad_norm_l2h000001' /Documents/data/rnn/multitask/varGo/lowD/most/
...
epoch = 'go1' # epoch = 2 #go1 epoch
model_n = 1
dir_specific_all = 'tanh/'#'lowD/combos' #'varGo/lowD/'#'lowD/combos' #'lowD/grad_norm_l2h000001' #' #'lowD/armnet_noreg'#'varGo/lowD/'#lowD/combos' ##grad_norm_l2h000001' /Documents/data/rnn/multitask/varGo/lowD/most/
model_dir = os.path.join(p,'data/rnn/multitask/',dir_specific_all,'most',str(model_n))
task_list = ['delaygo','delayanti'] #['fdgo', 'reactgo', 'fdanti', 'reactanti',  #'delaygo', 'delayanti',
            #   'delaydm1', 'delaydm2', 'contextdelaydm1', 'contextdelaydm2', 'multidelaydm',
            #   'dmsgo', 'dmsnogo', 'dmcgo', 'dmcnogo']
